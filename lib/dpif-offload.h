...

/* Global initialization function, called by dp initialization. */
void dp_offload_initialize(void);


/* Private function, only for use by dpif.c. */
struct ovs_list *dpif_offload_get_dpif_list_node(struct dpif_offload *);
