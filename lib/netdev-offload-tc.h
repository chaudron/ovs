...
//XXXX Rename after removal of callbacks...
int netdev_tc_flow_dump_create(struct netdev *, struct netdev_flow_dump **,
                               bool terse);
int netdev_tc_flow_dump_destroy(struct netdev_flow_dump *dump);
bool netdev_tc_flow_dump_next(struct netdev_flow_dump *dump,
